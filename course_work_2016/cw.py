...
from_time = get_time("20.10.2015 11.00.00")
to_time = get_time("20.10.2015 15.00.00")
...
report_df.drop_duplicates(subset=['LAC'], inplace=True)

report_dict = report_df.set_index('LAC').T.to_dict('list')
