...
namespace ConsoleExam
{
    internal sealed class StudentFactory
    {
        ...
        private List<String> names = new List<string> 
            {"Evgeniy", "Anton", "Ivan", "Pyotr", "Anastasia", "Lolita", "Bonnie", "Lana"};
        private List<String> surnames = new List<string> 
            { "Abramovich", "Demidovich", "Kozak", "Simpson", "Korotkevich", "Devich", "Johnson", "Williamson" };
        ...
        public Student GetRandomStudent()
        {
            ...
            return new Student(department, studentName, studentSurname);
        }
    }
}
